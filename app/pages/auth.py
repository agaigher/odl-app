...
def AuthPage(mode="login"):
    ...
    snowflake_icon = """<svg width="18" height="18" viewBox="0 0 24 24" fill="#29b5e8"><path d="M12 2l1.5 2.6-1.5.866V8l2-1.155 1-1.732 1.5.866-1 1.732L13.5 8.732 16 10.155l2.5-1.443.75 1.299L17 11.299V14l1.5-.866 1-1.732 1.5.866-1 1.732-1.5.866L20 17.4l-1.5.866-.5-.866-2 1.155v2.31l1.5.866-.75 1.299L15 22.164 13.5 23.03 12 22.164l-1.5.866L9 22.164 7.5 23.03 6 22.164l.75-1.299 1.5-.866v-2.31l-2-1.155-.5.866L4 16.534l1.5-2.6 1.5.866V11.3l-2.25-1.3.75-1.299L8 10.155l2.5-1.443-1.5-.868-1-1.732 1-.577 1 1.732 2 1.155V5.466l-1.5-.866L11.5 2H12z"/></svg>"""
